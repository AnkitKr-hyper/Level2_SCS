...
function showTheCards(){
    ...
    //From Here DOM manipulation begins;
...
function handleSearchFunctionality(){
    ...
    input.addEventListener("input", function(){
        ...
        document.querySelector(".searchdata").style.display = "block";// Beacause it is hiiden
        document.querySelector(".searchdata").innerHTML = clutter;  

    });

    // Add event listener to document to hide search results when clicked outside the search input
    document.addEventListener("click", function(event) {
    const searchInput = document.querySelector("#searchinput");
    const searchResults = document.querySelector(".searchdata");

    // Check if the clicked element is not the search input or search results
